...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    public class Model : ConventionalAnnotatable, IMutableModel
    {
        ...
        public virtual EntityType FindEntityType([NotNull] Type type)
            => _clrTypeMap.TryGetValue(Check.NotNull(type, nameof(type)), out EntityType entityType)
                ? entityType
        ...
        public virtual EntityType FindEntityType([NotNull] string name)
            => _entityTypes.TryGetValue(Check.NotEmpty(name, nameof(name)), out EntityType entityType)
                ? entityType
                : null;
        ...
        {
            if (_ignoredTypeNames.TryGetValue(name, out ConfigurationSource existingIgnoredConfigurationSource))
            {
        ...
        public virtual ConfigurationSource? FindIgnoredTypeConfigurationSource([NotNull] string name)
            => _ignoredTypeNames.TryGetValue(Check.NotEmpty(name, nameof(name)), out ConfigurationSource ignoredConfigurationSource)
