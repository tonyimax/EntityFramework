        ...
        public virtual InternalEntityTypeBuilder Apply(InternalEntityTypeBuilder entityTypeBuilder)
        {
                ...
                && ConfigurationSource.Convention.Overrides(entityType.GetPrimaryKeyConfigurationSource()))
            {
                ...
                if (entityType.HasDelegatedIdentity())
                {
                    ...
                    foreach (var foreignKey in entityType.GetForeignKeys().Where(fk => fk.IsUnique))
                    {
                        ...
                        keyProperties = foreignKey.Properties;
                    }

                    keyPropertyNames = keyProperties?.Select(p => p.Name).ToList();
                }
