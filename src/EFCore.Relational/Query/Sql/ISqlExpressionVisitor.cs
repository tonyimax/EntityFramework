...
namespace Microsoft.EntityFrameworkCore.Query.Sql
{
    ...
    public interface ISqlExpressionVisitor
    {
        ...
        /// <summary>
        ///     Visit a ProjectStarExpression.
        /// </summary>
        /// <param name="projectStarExpression"> The ProjectStarExpression expression. </param>
        /// <returns>
        ///     An Expression.
        /// </returns>
        Expression VisitProjectStar(ProjectStarExpression projectStarExpression);
    }
}